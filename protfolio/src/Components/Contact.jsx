        ...
        <div className="back">
          <div className="row">
            ...
            <div className="contact-left">
              <p>
                <span style={{fontWeight:'bold' , color:'rgb(188, 51, 78)'}}> Email Id:</span> dhanusharavikannan21@gmail.com
              </p>
              <p>
                <span style={{fontWeight:'bold',color:'rgb(188, 51, 78)'}}> Phone No: </span> (+91) 9361884122
              </p>
