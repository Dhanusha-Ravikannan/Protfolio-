...
const Project = () => {
  const projects = [
    ...
    },
    {
      ...
      overview: `A responsive inventory and billing management system tailored for a jewellery business, designed to automate operations, minimize manual errors, and improve workflow efficiency.`,
      features: [
        "Full-fledged inventory and billing system.",
        "Auto weight calculations and dynamic product numbers.",
        "QR code generation and scanning for products.",
        "Status transition from 'Active' to 'Sold'.",
        "Lot-based product grouping and filtering.",
        "PDF export and real-time weight tracking.",
      ],
    },
    {
      title: "Good Foods",
      image: foodImage,
      github: "https://github.com/Dhanusha-Ravikannan/Good-Food",
      overview: `A subscription-based food ordering platform with automated daily deliveries. Admins manage the menu, users manage plans.`,
      features: [
        "Admin-created subscription plans.",
        "Daily meal auto-ordering and skipping logic.",
