...
<div className="skills-grid">
  ...
  <SkillCard icon={<SiTailwindcss className="skill-icon" />} title="Tailwind CSS" />
      ...
      <div className="skills-grid">
        ...
        <SkillCard icon={<FaCloudUploadAlt className="skill-icon" />} title="Render Deployment" />
      ...
      <div className="skills-grid">
        ...
        <SkillCard icon={<FaCode className="skill-icon" />} title="VS Code" />
      ...
      <div className="skills-grid">
        ...
        <SkillCard icon={<MdOutlineWork className="skill-icon" />} title="Recruitment" />
        <SkillCard icon={<MdSchool className="skill-icon" />} title="Training & Development" />
